...
PUBLIC _var_134
PUBLIC _var_135
EXTRN _sub_122B8:near
EXTRN _sub_1A9F8:near
PUBLIC _sub_1B147
PUBLIC _word_39200
PUBLIC _word_3B4D2
PUBLIC _word_3C8B2
...
; ------------------------------seg000:0x6171------------------------------
; ------------------------------seg000:0x6172------------------------------
; sub_16172 - moved to egame1.c
; ------------------------------seg000:0x6345------------------------------
; ------------------------------seg000:0x6346------------------------------
EXTRN _sub_16346:NEAR
; ------------------------------seg000:0x67b4------------------------------
sub_167B4 proc near
    push BP
    mov BP,SP
