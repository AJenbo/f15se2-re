                    ...
                    if (g != -1) {
                        ...
                        for (d = 0; matrix3dt[word_3C16C + 3][g + 3] > (unsigned int)d; d++) {
                            if (*((int *)word_3C5A8 + 2) == 0) {
                                ...
                                var_201 = 0x228d;
                                sub_136D2((char far *)MK_FP(var_201, var_200),
...
int sub_132BA(uint32 coord1, uint32 coord2, uint32 coord3)
{
    ...
    word_3B7E2 = 0x7fff;
    b = 4;
    k = sub_126B4(4, coord1);
    g = (int)(k >> 12);
    a = (int)k & 0xfff;
    k = sub_126B4(4, coord2);
    i = (int)(k >> 12);
    c = (int)k & 0xfff;
    var_220 = (int)sub_126B4(4, coord3);
    m = 0x800 - a;
    p = 0x800 - c;
    var_218 = a - 0x800;
    var_219 = c - 0x800;
    ...
    if (word_3B7E2 != 0x7fff) {
        ...
        var_200 = buf3d3[*((unsigned char *)word_3B7EC + 6)] + 0;
        var_201 = 0x228d;
        ...
        var_216 = 0;
        sub_202DA();
        if (*((char far *)MK_FP(var_201, var_200)) & 0x40) {
            var_215 = 0;
            sub_2044A();
        }
    }
